...
export function drawRoom(canvas,task,frame,previous,blend=1,trail=[]){const g=canvas.getContext('2d'),s=frame.state;g.clearRect(0,0,840,600);g.fillStyle='#e5e8dc';g.fillRect(0,0,840,600);
